...
* `entity.spawn <entity> [position] [rotation]` - Native-compatible player console alias for spawning an entity (require `adminutilities.spawn`).
...
* `entity.spawn <entity> [position] [rotation]` - Native-compatible player console alias for spawning an entity.
